    ...
    <section id="faq" className="bg-[#0D0D0D] py-16 md:py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="bg-white/[0.02] backdrop-blur-sm border border-white/5 rounded-3xl p-6 md:p-10 [will-change:transform,opacity] [backface-visibility:hidden] [transform-style:preserve-3d]"
        >
        ...
        <motion.div
          ...
          className="mt-16 relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl p-8 md:p-12 text-center [will-change:transform,opacity] [backface-visibility:hidden] [transform-style:preserve-3d]"
        >
